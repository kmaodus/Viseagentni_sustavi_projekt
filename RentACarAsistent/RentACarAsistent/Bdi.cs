...
namespace RentACarAsistent
{
    public abstract class Bdi<T>
    {
        ...
        protected abstract IEnumerable<Koncept<TipIntencije, T>> IzborCiljeva(IEnumerable<Koncept<TipŽelja, T>> želje);
        protected abstract T IzborSredstava(IEnumerable<Koncept<TipIntencije, T>> intencije);
    }
}
